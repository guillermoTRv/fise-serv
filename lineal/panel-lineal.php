...
<head>
    ...
    .infomat{
            color:rgba(123, 132, 218, 1);font-size:90%;font-weight:bolder;
    }
    a.infomat:hover{
            color:rgba(123, 132, 218, 1);
            text-decoration:none;
            ...
            <div class="col-md-3 columleft">
                <div class="panel panel-default fk">
                    <div class="panel-body">
                        ...
                        <?php 
                            $css_b="style='max-width:200px;background-color:rgba(123, 132, 218, 1);color:white;'";
                        ...
                        <div class="row">
                            <div class="media">
                                <div class="media-left media-middle">
                                    <img class="img-circle hidden-xs" src="../image/lineal.jpg" alt="Generic placeholder image" width="66" height="66" style="margin-left:15px;">
                                </div>
