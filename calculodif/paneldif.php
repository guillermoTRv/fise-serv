...
<head>
	...
	.hovermat > li > a:focus {
	  ...
	  background-color:rgba(143, 122, 165, .36);
	}
    .fenmat{
      font-family:cursive;
      margin-bottom:120px;   
	...
	.infomat{
            color:rgba(143, 122, 165, 1);font-size:90%;font-weight:bolder;
    }
    a.infomat:hover{
            color:rgba(143, 122, 165, 1);
            text-decoration: none;
    }
    </style>
</head>
            ...
            <div class="col-md-3 columleft">
    			<div class="panel panel-default fk">
                    <div class="panel-body">
                        ...
                        <?php 
                            $css_b="style='max-width:200px;background-color:rgba(143, 122, 165, 1);color:white;'";
                        ...
                        <div class="row">
                            <div class="media">
                                <div class="media-left media-middle">
                                    <img class="img-circle hidden-xs" src="../image/dif.jpg" alt="Generic placeholder image" width="66" height="66" style="margin-left:15px;">
                                </div>
