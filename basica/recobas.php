...
<html>
<head>
	<title>Recomendaciones álgebra básica</title>
				...
				<div class="panel panel-default fk" style="border-radius:10px;">
					<div class="panel-body">
						<div class="row">
                            ...
                            <div class="col-md-7 col-sm-8"><h1>Recomendaciones de Algebra <?php $b='básica'; echo utf8_encode($b); ?></h1></div>
                            <div class="col-md-4">
                                <div class="dropdown" style="margin-top:24px;float:rigth;">
                                 <button style="max-width:200px;background-color:rgba(54, 134, 164, .9);color:white;" class="btn dropdown-toggle " type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Mas de la materia
                                     <span class="caret"></span>
                                 </button>
                                        <ul class='dropdown-menu hoverbas' aria-labelledby='dropdownMenu1'>
                                            <li><a href='http://fiseaprende.com/basica/lista-algebrabasica'>Lista de la materia</a></li>
