<?php 
    ...
    global $metaria; $materia="Estadistica"; 
...
<head>
	...
	.hovermat > li > a:focus {
	  ...
	  background-color: rgba(0, 177, 64, .35);
	}
    .fenmat{
      font-family:cursive;
      margin-bottom:120px;   
	...
	a.fenmat:focus {
	  color: white;
	  text-decoration: none;
	  background-color:rgba(0, 177, 64, .96);
	}
	.amounmat{
            color:rgba(0, 177, 64, .93);
    }
    a.amounmat:hover{
            color:rgba(0, 177, 64, .93);
            text-decoration: none;   
	...
	.infomat{
            color:rgba(0, 177, 64, .93);font-size:90%;font-weight:bolder;
    }
    a.infomat:hover{
            color:rgba(0, 177, 64, .93);
            text-decoration:none;
            ...
            <div class="col-md-3 columleft">
    			<div class="panel panel-default fk">
                    <div class="panel-body">
                        ...
                        <?php 
                            $css_b="style='max-width:200px;background-color:rgba(0, 177, 64, .93);color:white;'";
                        ...
                        <div class="row">
                            <div class="media">
                                <div class="media-left media-middle">
                                    <img class="img-circle hidden-xs" src="../image/est.jpg" alt="Generic placeholder image" width="66" height="66" style="margin-left:15px;">
                                </div>
